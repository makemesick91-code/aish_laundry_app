...
/// Console Web sign-in.
///
/// On success the server sets an HTTP-only session cookie. This screen never
/// receives, stores, or reads a token: there is no `localStorage` or
/// `sessionStorage` access anywhere in this surface, and a test asserts it.
///
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (value) =>
                          ...
                          ? 'Isi email atau nomor telepon Anda.'
                          : null,
                    ...
                    PrimaryAction(
                      label: 'Masuk',
                      semanticLabel: 'Masuk ke Aish Laundry Console',
                      isBusy: _busy,
                      onPressed: _submit,
                    ),
                  ],
